...
public class ProductoControllerImpl implements ProductoController {
	...
	public Producto createProducto(@RequestBody Producto request,
							   	   ...
							   	   Authentication auth) {
		return service.createProducto(request, restaurantId,
	...
	public Producto getProducto(@PathVariable("productoId") long productoId,
								@PathVariable("restaurantId") long restaurantId,
								Authentication auth) {
		return service.findById(productoId, restaurantId,
								Long.parseLong(auth.getName()));
	}
	...
	public void editProducto(@PathVariable("restaurantId") long restaurantId,
							 @PathVariable ("productoId") long productoId,
							 @RequestBody Producto request,
							 Authentication auth) {
		service.updateProducto(restaurantId, productoId, request,
							   Long.parseLong(auth.getName()));
	}
	...
	public String cambiarEstadoProducto(@PathVariable("restaurantId") long restaurantId,
										@PathVariable ("productoId") long productoId,
										Authentication auth) {
		return service.cambiarEstadoProducto(restaurantId, productoId,
											 Long.parseLong(auth.getName()));
	}
