...
public interface PedidoController {
	...
	@Operation(summary = "Agregar un producto para un determinado pedido",
            description = "Acción realizada por el operador del respectivo restaurant")
    public void addProducto(long restaurantId, long pedidoId,
    						long productoId, Authentication auth);
	
	@Operation(summary = "Editar un determinado pedido",
            description = "Acción realizada por el operador del respectivo restaurant")
    public void editarPedido(long restaurantId, long pedidoId,
    						 NewPedido request, Authentication auth);
    ...
    description = "Acción realizada por el operador del respectivo restaurant")
    public Factura liberarPedido(long restaurantId, long mesaId,
    							 long pedidoId, Authentication auth);
