...
public interface DeliveryController {
    ...
    public Delivery crearDelivery(NewDelivery request, Long restaurantId,
    							  List<Integer> productList, Authentication auth);
	...
	@Operation(summary = "Aplicación de un descuento a un pedido delivery",
            description = "Acción realizada por el operador del respectivo restaurant")
    public void aplicarDescuento(long restaurantId, long deliveryId,
    							 Double porcentajeDescuento, Authentication auth);

	@Operation(summary = "Pago de un pedido delivery",
            description = "Acción realizada por el operador del respectivo restaurant")
    public Factura liberarPedido(long restaurantId, long deliveryId,
    							 Authentication auth);

	@Operation(summary = "Agregar un producto a un nuevo pedido delivery",
            description = "Acción realizada por el operador del respectivo restaurant")
    public void addProducto(long restaurantId, long deliveryId,
    						List<Integer> productList, Authentication auth);
