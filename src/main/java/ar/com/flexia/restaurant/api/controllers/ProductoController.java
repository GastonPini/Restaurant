...
public interface ProductoController {
	...
	public Producto createProducto(Producto request, long restaurantId,
								   Authentication auth);

	@Operation(summary = "Obtener un determinado producto",
            description = "Acción realizada por el operador del respectivo restaurant")
    public Producto getProducto(long productoId, long restaurantId,
    							Authentication auth);
    ...
    public void editProducto(long restaurantId,long productoId, 
                             Producto request, Authentication auth);
	
	@Operation(summary = "Inactivar un producto determinado para la venta",
            description = "Acción realizada por el operador del respectivo restaurant")
	public String cambiarEstadoProducto(long restaurantId, long productoId,
										Authentication auth);
