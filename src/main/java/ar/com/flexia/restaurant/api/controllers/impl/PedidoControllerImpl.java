...
public class PedidoControllerImpl implements PedidoController {
	...
	public Pedido createPedido(@RequestBody NewPedido request, @PathVariable("mesaId") long mesaId,
							 @PathVariable("restaurantId") long restaurantId,
							 @RequestParam("productos") List<Integer> productos,
							 Authentication auth) {
		return service.createPedido(request, mesaId, restaurantId,productos, Long.parseLong(auth.getName()));
	}
	...
	public List<Pedido> getPedidos(@PathVariable("restaurantId") long restaurantId, Authentication auth) {
	...
	public void addProducto(@PathVariable("restaurantId") long restaurantId,
							...
							Authentication auth) {
		service.addProducto(restaurantId, pedidoId, productoId, Long.parseLong(auth.getName()));
	}
	...
	public void editarPedido(@PathVariable("restaurantId") long restaurantId,
								 @PathVariable("pedidoId") long pedidoId,
								 @RequestBody NewPedido pedido,
								 Authentication auth) {
		service.editarPedido(restaurantId, pedidoId, pedido, Long.parseLong(auth.getName()));
	}
	...
	public void aplicarDescuento (@PathVariable("restaurantId") long restaurantId,
								  ...
								  Authentication auth){
		service.aplicarDescuento(restaurantId, mesaId, pedidoId, porcentajeDescuento, Long.parseLong(auth.getName()));
	}
	...
	public Factura liberarPedido(@PathVariable("restaurantId") long restaurantId,
								 ...
								 @PathVariable("pedidoId") long pedidoId,
								 Authentication auth) {
		return service.liberarPedido(restaurantId, mesaId, pedidoId, Long.parseLong(auth.getName()));
	}
